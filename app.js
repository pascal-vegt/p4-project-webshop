`
<a class="main-first-section-list-item nodec" href="./category.html">
...
`
<div class="main-second-section-list-item">
<img class="main-second-section-list-item-image" src="${brands.imagepath}" alt="test image">
</img><h1 class="main-second-section-list-item-title">${brands.name}</h1>
</div>
`
